...
//                    LLMClient.ModelType.LLAMA3_8B));
    ...
    /**
     * <p>
     *     This function will call local LLM model to generate structural JSON post
     * </p>
     * @param post - The rental post
     * @param model - The model type you want the LLM be.
    ...
    public JSONObject getJSONPostNoError(String post , LLMClient.ModelType model) {
        JSONObject jsonPost;
        while ((jsonPost = noErrorJSONPost(post, model)) == null);
        return jsonPost;
    }
